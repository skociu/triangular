...
- Adjustable number of rows (1-60)
- Toggle triangle orientation (point up/down)
- Customizable shape size, edge color, fill color, and text color
- Adjustable spacing between shapes
- Optional numbered labels on each shape
